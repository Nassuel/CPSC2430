/**
  * @file ConcordanceApp4.h - header file of ConcordanceApp4
...
private:
	...
	/**
	 * Takes a List of WordRefs and prints the lines where the word looked up is located.
	 *
	 * @param name string to read
	 * @return enum Command 
	 *
