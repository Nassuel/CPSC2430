...
#include <sstream>
#include <stdexcept>
#include "ConcordanceM.h"
using namespace std;

const Concordance::BookInfo& ConcordanceM::loadBook(string bookname, string filename) {
...
void ConcordanceM::unloadBook(string bookname) {
...
const List<Concordance::WordRef>& ConcordanceM::lookupWord(string word) const {
...
ListA<Concordance::WordInfo> *ConcordanceM::wordList(string start) const {
...
string ConcordanceM::getLine(string bookname, int lineNumber) const {
...
string ConcordanceM::depunctuate(string word) {
    string s = word;
...
Concordance::WordInfo ConcordanceM::maxWord(int length) const {
    WordInfo info;
