/**
 * @file ConcordanceH.cpp - implementation for ConcordanceH class
...
#include <sstream>
#include <stdexcept>
#include "ConcordanceH.h"
using namespace std;

const Concordance::BookInfo& ConcordanceH::loadBook(string bookname, string filename) {
...
void ConcordanceH::unloadBook(string bookname) {
...
const List<Concordance::WordRef>& ConcordanceH::lookupWord(string word) const {
...
ListA<Concordance::WordInfo> *ConcordanceH::wordList(string start) const {
...
string ConcordanceH::getLine(string bookname, int lineNumber) const {
...
string ConcordanceH::depunctuate(string word) {
    string s = word;
...
Concordance::WordInfo ConcordanceH::maxWord(int length) const {
    WordInfo info;
